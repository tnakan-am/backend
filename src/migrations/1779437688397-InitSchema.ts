...
export class InitSchema1779437688397 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_type_enum" AS ENUM('customer', 'business', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."products_unit_enum" AS ENUM('kg', 'gram', 'liter', 'qnt')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."products_deliveryoption_enum" AS ENUM('Nearest', 'Next Day', 'After Next Day', 'On WeekEnd')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_1efd59fd70f18d1f97d0247501" ON "products" ("avgReview") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_62e458ba8467ba3c6246c47b93" ON "products" ("approved") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_9e64a98845975f58aea17a22db" ON "products" ("productCategory") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_cab13b3a21a939b139da80eaa9" ON "products" ("subCategory") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_07910e95f7b581a71ae41dda06" ON "product_categories" ("subCategoryId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "sub_categories" ("id" character varying(120) NOT NULL, "categoryId" character varying(100) NOT NULL, "name" character varying(100) NOT NULL, "description" text, "image" character varying, "isActive" boolean NOT NULL DEFAULT true, "sortOrder" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f319b046685c0e07287e76c5ab1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dfa3adf1b46e582626b295d025" ON "sub_categories" ("categoryId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" character varying(100) NOT NULL, "name" character varying(100) NOT NULL, "description" text, "icon" character varying, "image" character varying, "isActive" boolean NOT NULL DEFAULT true, "sortOrder" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."order_products_status_enum" AS ENUM('pending', 'processing', 'delivered', 'seen')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_6a69fd94a872298cb4e0694d2f" ON "order_products" ("vendorId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."order_status_history_status_enum" AS ENUM('pending', 'processing', 'delivered', 'seen')`,
    );
    await queryRunner.query(
      `CREATE TABLE "order_status_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderId" uuid NOT NULL, "userId" uuid NOT NULL, "status" "public"."order_status_history_status_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e6c66d853f155531985fc4f6ec8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_689db3835e5550e68d26ca3267" ON "order_status_history" ("orderId") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('pending', 'processing', 'delivered', 'seen')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_53a68dc905777554b7f702791f" ON "reviews" ("orderId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a6b3c434392f5d10ec17104366" ON "reviews" ("productId") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_status_enum" AS ENUM('pending', 'processing', 'delivered', 'seen')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_fe1b8ba550e73f84ff228401aa" ON "notifications" ("orderId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_21e65af2f4f242d4c85a92aff4" ON "notifications" ("userId", "createdAt") `,
    );
    await queryRunner.query(
      `ALTER TABLE "product_categories" ADD CONSTRAINT "FK_07910e95f7b581a71ae41dda060" FOREIGN KEY ("subCategoryId") REFERENCES "sub_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sub_categories" ADD CONSTRAINT "FK_dfa3adf1b46e582626b295d0257" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_categories" DROP CONSTRAINT "FK_07910e95f7b581a71ae41dda060"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_21e65af2f4f242d4c85a92aff4"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fe1b8ba550e73f84ff228401aa"`,
    );
    await queryRunner.query(`DROP TABLE "notifications"`);
    await queryRunner.query(`DROP TYPE "public"."notifications_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a6b3c434392f5d10ec17104366"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_53a68dc905777554b7f702791f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_689db3835e5550e68d26ca3267"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6a69fd94a872298cb4e0694d2f"`,
    );
    await queryRunner.query(`DROP TABLE "order_products"`);
    await queryRunner.query(`DROP TYPE "public"."order_products_status_enum"`);
    await queryRunner.query(`DROP TABLE "categories"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dfa3adf1b46e582626b295d025"`,
    );
    await queryRunner.query(`DROP TABLE "sub_categories"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_07910e95f7b581a71ae41dda06"`,
    );
    await queryRunner.query(`DROP TABLE "product_categories"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_99d90c2a483d79f3b627fb1d5e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c3932231d2385ac248d0888d95"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cab13b3a21a939b139da80eaa9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9e64a98845975f58aea17a22db"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_62e458ba8467ba3c6246c47b93"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1efd59fd70f18d1f97d0247501"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."products_deliveryoption_enum"`,
    );
